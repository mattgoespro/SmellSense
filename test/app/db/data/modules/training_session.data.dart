...
import 'training_session_entry.data.dart';

TrainingSession testTrainingSession = TrainingSession(
  id: "c41089d9-1af3-4167-8db1-027db951e6c3",
  date: DateTimeUtils.date(),
  entries: testTrainingSessionEntries,
);
