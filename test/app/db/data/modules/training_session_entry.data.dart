...
List<TrainingSessionEntry> testTrainingSessionEntries = [
  TrainingSessionEntry(
    ...
    parosmiaReaction: TrainingSessionEntryAlteredReaction.neutral,
    parosmiaReactionSeverity: TrainingSessionEntryAlteredReactionSeverity.mild,
    comment:
  ...
  TrainingSessionEntry(
    ...
    parosmiaReaction: TrainingSessionEntryAlteredReaction.none,
    parosmiaReactionSeverity: TrainingSessionEntryAlteredReactionSeverity.none,
    comment: "Lavender is smelling as it should.",
  ),
  TrainingSessionEntry(
    id: "bdd636f2-041b-4dd3-9e2d-792eed06135c",
    scent: testTrainingScents[2],
    rating: TrainingSessionEntryRating.strong,
    parosmiaReaction: TrainingSessionEntryAlteredReaction.none,
    parosmiaReactionSeverity: TrainingSessionEntryAlteredReactionSeverity.none,
